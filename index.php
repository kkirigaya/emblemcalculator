...
echo '<h1>Kindness and Captivity Emblems Calculator</h1>';
...
echo '<p class="totals">';
	echo '<span class="bronzeNeededTotal">(Click Calculate)</span> more Bronze<br/>';
		echo '&nbsp;&nbsp;&nbsp;<span class="moreSentinelsBronze"></span> Expert Sentinels (at 13/run)<br/>&nbsp;&nbsp;&nbsp;<span class="moreHostedBeginnerRaidsBronze"></span> Hosted Beginner Raids (at 24/run)</br>&nbsp;&nbsp;&nbsp;<span class="moreJoinedBeginnerRaidsBronze"></span> Joined Beginner Raids (at 16/run)</br><br/>';
...
echo '<p class="perday"><span class="bronzeNeededToday">(Click Calculate)</span> more Bronze - which is approximately<br/>';
	echo '&nbsp;&nbsp;&nbsp;<span class="moreSentinelsBronze"></span> Expert Sentinels (at 13/run)<br/>&nbsp;&nbsp;&nbsp;<span class="moreHostedBeginnerRaidsBronze"></span> Hosted Beginner Raids (at 24/run)</br>&nbsp;&nbsp;&nbsp;<span class="moreJoinedBeginnerRaidsBronze"></span> Joined Beginner Raids (at 16/run)</p>';
